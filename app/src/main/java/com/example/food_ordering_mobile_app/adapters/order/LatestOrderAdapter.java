    ...
    public class LatestOrderAdapter extends RecyclerView.Adapter<LatestOrderAdapter.ViewHolder> {
        ...
        public interface OnOrderClickListener {
            ...
            void onNextStatusClick(Order order);
        }
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.btnDetail.setOnClickListener(v -> {
                ...
                FragmentOrderDetail fragment = FragmentOrderDetail.newInstance(order.getId(), "1");
            ...
            holder.btnConfirm.setOnClickListener(v -> {
                if (onOrderClickListener != null) {
                    onOrderClickListener.onNextStatusClick(order);
                }
            });
        }
